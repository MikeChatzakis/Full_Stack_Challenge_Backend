...
const { create_emp_skill_post, create_many_skills_post, all_emp_all_skills_get, single_employee_all_skills_get,employee_skill_delete} = require('../controllers/employeeSkillController');
